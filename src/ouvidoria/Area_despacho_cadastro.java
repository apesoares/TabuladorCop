...
public class Area_despacho_cadastro extends javax.swing.JDialog {
     ...
     */
    public Area_despacho_cadastro() {
        initComponents();
    }

    public Area_despacho_cadastro(Menu mn, boolean modal) {
        super(mn, modal);
        initComponents();
        ...
        global.open_modal(this, "Cadastro de Áreas de Despacho");
    ...
    public void atualiza_painel() {
        ...
        String query = "select id, cidade, area "
                + "from ouvidoria.areas_novo "
                + "where cidade like '%" + jtxt_localizar.getText().trim() + "%' "
                + "group by cidade, area order by cidade, area;";
        ...
        try {
            ...
            int invisible_ids[] = {0};
            int column_widths[] = {50, 150, 150, 150};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cidade a localizar (parte ou todo)");
    ...
    private void jmni_servicos_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmni_servicos_alterarActionPerformed
        ...
        if (!testaEdicao()) {
            ...
            Area_despacho_cadastro_editar cad_area_despacho_editar = new Area_despacho_cadastro_editar(
                    1,
                    Integer.parseInt(main_tab.getModel().getValueAt(main_tab.getSelectedRow(), 0).toString()),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Area_despacho_cadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Area_despacho_cadastro().setVisible(true);
            }
        });
    }
