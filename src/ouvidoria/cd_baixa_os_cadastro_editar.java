 ...
 * @author ROBSMAC
 */
public class cd_baixa_os_cadastro_editar extends javax.swing.JDialog {
    ...
    public cd_baixa_os_cadastro_editar() {
        initComponents();
    }
     ...
     * @param sCOP
     */
    public cd_baixa_os_cadastro_editar(Integer iEdicao, Integer iID, String sCodigo, String sQuebra, String sCOP) {
        initComponents();
        ...
        this.setTitle("Código de Baixa de OS - ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cd_baixa_os_cadastro_editar.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cd_baixa_os_cadastro_editar(iEdicao, iID, sCodigo, sQuebra, sCOP).setVisible(true);
